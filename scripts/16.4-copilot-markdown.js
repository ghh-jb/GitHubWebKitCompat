    ...
    ["packages_copilot-markdown_MarkdownRenderer_tsx"],
    {
        39876: (e, n, o) => {
            ...
            function a(e, n, o) {
                ...
                return { publicCodeReferences: a, codeVulnerabilities: t };
            }
        },
        23967: (e, n, o) => {
            function s(e) {
                let n = e.toUpperCase(),
                    o = r[n];
                return (!o && t[n] && (o = r[t[n]]), o ?? { name: e });
            }
            o.d(n, { Yr: () => a, r4: () => r, vL: () => s });
                ...
                $ = (0, t.forwardRef)(function (e, n) {
                    let o,
                        ...
                        et = (0, a.c)(48),
                        {
                            ...
                            markdown: ei,
                            chatMode: el,
                            openLinksInCurrentTab: ec,
                            extensions: em,
                            isStreaming: ex,
                            accessibleHeader: ed,
                            copilotAnnotations: ep,
                            wrapCodeLines: eE,
                            onWrapCodeLinesChange: eA,
                        } = e,
                        ef = void 0 === em ? z : em,
                        [eS, eC] = (0, t.useState)(ex ?? !1);
                    (et[0] !== ex
                        ? ((o = () => {
                              if (ex) eC(!0);
                              else {
                        ...
                        : ((o = et[1]), (r = et[2])),
                        (0, t.useEffect)(o, r),
                        et[3] === Symbol.for("react.memo_cache_sentinel")
                            ? ((l = {
                                  transformMarkdown: (e) =>
                                      (0, T.YR)(e, "code", (e) => {
                                          e.data = {
...
|.)+?)${n.source}(?= *(?:\\n|$))`,
                            ...
                            : ((l = et[3]), (c = et[4])),
                        et[5] !== ec
                            ? ((m = (function ({ openLinksInCurrentTab: e }) {
                                  return { transformHtml: e ? void 0 : v };
                              })({ openLinksInCurrentTab: ec })),
                              (et[5] = ec),
                              (et[6] = m))
                            : (m = et[6]),
                        et[7] !== eS
                            ? ((p = (function ({ isStreaming: e }) {
                                  return e
                                      ? {
                                            preprocessMarkdown: (
                                                e
...
\uE000`,
                    ...
                    (et[16] !== i
                        ? ((S = () => [
                          ...
                          (et[17] = S))
                        : (S = et[17]),
                        et[18] === Symbol.for("react.memo_cache_sentinel")
                            ? ((C = []), (L = []), (et[18] = C), (et[19] = L))
                            : ((C = et[18]), (L = et[19])));
                    let [eR] = (0, q.I)(S, C, L),
                        eT = (function (e) {
...
NOTE: This error may be safely ignored if it occurs due to hot-reloading in local development.`));
            ...
            function m(e) {
                ...
                return (
                    ...
                    x[6] !== E
                        ...
                        : (l = x[7]),
                    x[8] !== t || x[9] !== l
                        ? ((m = (0, s.jsxs)("details", { children: [t, l] })),
                          (x[8] = t),
                          (x[9] = l),
                          (x[10] = m))
                        : (m = x[10]),
                ...
                return (
                    ...
                    l[4] !== m
                        ? ((r =
                              m &&
                              m.length > 0 &&
                              (0, s.jsx)(p, { vulnerabilities: m.map(S) })),
                          (l[4] = m),
                          (l[5] = r))
                        : (r = l[5]),
                    l[6] !== E || l[7] !== o || l[8] !== r
        ...
        31339: (e, n, o) => {
            ...
            var s = o(74848),
                a = o(21728);
            let t = { languageDot: "LanguageDot-module__languageDot--O6n2z" };
            function r(e) {
                let n,
                    o = (0, a.c)(2),
                    { color: r } = e;
        ...
        98755: (e, n, o) => {
            ...
            var s = o(74848),
                ...
                m = o(4559),
                x = o(40260);
            let d = { tooltip: "CopyToClipboardButton-module__tooltip--HDUYz" };
            function p({
                icon: e = t.CopyIcon,
                size: n = "medium",
                onCopy: o,
