"use strict";
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([["ui_packages_list-view_src_hooks_use-next-header-tag_ts-ui_packages_list-view_src_ListItem_Lis-0a5d95"], {
    31668: (e, t, r) => {
        r.d(t, {
            E7: () => F
        });
        ...
        let l = (0, a.createContext)({
            ...
            n = ({ children: e, value: { actions: t = [], staticMenuActions: r, variant: n = "toolbar", label: s, gap: o } }) => {
                let c = (0, a.useMemo)(() => ({
                    actions: t,
                    staticMenuActions: r,
                    variant: n,
            ...
            s = () => {
                ...
                if (!e)
                    throw Error("useActionBarContent must be used with ActionBarContentProvider.");
                return e
            };
        try {
        ...
        let o = (0, a.createContext)({
            ...
            d = () => {
                ...
                if (!e)
                    throw Error("useActionBarRef must be used with ActionBarRefProvider.");
                return e
            };
        try {
        ...
        let y = e => {
            ...
            f = (e, t) => {
                ...
                return i + (a?.marginLeft ? parseInt(a.marginLeft, 10) : 0) + (a?.marginRight ? parseInt(a.marginRight, 10) : 0) + r
            },
            p = (e, t) => {
                let r = x(e, t);
                if (void 0 === r)
            ...
            N = e => "condensed" === e ? "var(--base-size-4)" : "spacious" === e ? "var(--base-size-16)" : "none" === e ? 0 : "var(--base-size-8)",
            w = (0, a.createContext)({
            ...
            b = ({ children: e, value: { actionKeys: t } }) => {
                let r = t.length,
                    ...
                    [c, u] = (0, a.useState)(),
                    [y, N] = (0, a.useState)(),
                    [b, C] = (0, a.useState)(new Map(t.map(e => [e, void 0]))),
                    [A, g] = (0, a.useState)(!1),
                    j = (0, a.useMemo)(() => t.slice(0, l).every(e => b.has(e) && "number" == typeof b.get(e)), [t, b, l]),
                    I = (0, a.useCallback)(e => {
                        let r = t[e];
                        if (r)
                            return b.get(r)
                    ...
                    P = (0, a.useCallback)(() => {
                        ...
                        if (!e || !t)
                            return;
                        let r = e.offsetWidth;
                        r && (void 0 === c || r <= c ? L() : r > c && _(), u(r), g(r <= (y ?? t.offsetWidth)))
                    }, [_, L, y, c, s, o]);
                (0, h.A)(() => {
                    let e = o.current;
                    if (!e)
        ...
        let B = {
            ...
            R = "invisible",
            V = ({ anchorProps: { "aria-label": e, icon: t = T, variant: r = R, ...l } = {
                icon: T,
                variant: R
            } }) => {
                let { anchorRef: n } = d(),
                    ...
                    y = v && v.length > 0,
                    f = c && c.length > 0;
                return y || f ? (0, i.jsxs)(P.W, {
                    anchorRef: n,
                    children: [(0, i.jsx)(P.W.Anchor, {
                        ...
                        children: (0, i.jsxs)(M.l, {
                            children: [f && c.map(e => (0, i.jsx)(a.Fragment, {
                                children: e.render()
                            }, e.key)), v?.map(e => (0, i.jsx)(a.Fragment, {
                                children: e.render(!0)
                            }, e.key))]
                        })
                    })]
        ...
        let W = {
            ...
            H = ({ className: e, style: t }) => {
                ...
                return (0, i.jsx)("div", {
                    ...
                    children: o?.map(({ key: e, render: t }) => (0, i.jsx)(z, {
                        actionKey: e,
                        children: t(!1)
                    }, e))
                })
        ...
        try {
            $.displayName || ($.displayName = "VisibleAndOverflowContainer")
        } catch { }
        let D = "normal",
            K = ({ children: e, ...t }) => (0, i.jsx)($, {
                ...t,
                children: e
            }),
            F = ({ actions: e = [], staticMenuActions: t, overflowMenuToggleProps: r, children: l, label: s, variant: o, density: d = D, anchorRef: u, className: m, style: h }) => {
                let v = (0, a.useMemo)(() => ({
                    actions: e,
                    staticMenuActions: t,
                    variant: o,
    ...
    8241: (e, t, r) => {
        ...
        var i = r(96540);
        function a(e, { isPropUpdateDisabled: t = !1, isEqual: r = Object.is } = {}) {
    ...
    87854: (e, t, r) => {
        ...
        var i = r(74848),
            ...
            o = r(16946);
        let c = {
            container: "ActionBar-module__container--ZVTfi",
            hasActions: "ActionBar-module__hasActions--cU9tJ"
        },
            d = ({ anchorIcon: e, style: t, className: r, label: d = "list item action bar", ...u }) => {
                let { setAnyItemsWithActionBar: m, setHasResizableActionsWithActionBar: h } = (0, o.Z)();
                return (0, s.useEffect)(() => m(!0), [m]), (0, s.useEffect)(() => {
                    u.actions && h(!0)
                }, [u.actions, h]), (0, i.jsx)("div", {
                    className: (0, n.$)(c.container, u.actions && c.hasActions, r),
                    style: t,
    ...
    510: (e, t, r) => {
        ...
        let s = () => {
            let e = (0, a.useContext)(l);
            if (!e)
                throw Error("useListItemDescription must be used with DescriptionProvider.");
            return e
        };
        try {
    ...
    78168: (e, t, r) => {
        ...
        var v = r(510);
        let y = {
            listItem: "ListItem-module__listItem--kHali",
            compact: "ListItem-module__compact--z60S6",
            hasActionBar: "ListItem-module__hasActionBar--av1aD",
        ...
        var N = r(98391),
            ...
            b = r(65710),
            C = r(14918);
        let A = ({ children: e, isActive: t = !1, title: r, metadata: a, secondaryActions: m, style: h, className: f, metadataContainerStyle: p, metadataContainerClassName: A, as: g, ...j }) => {
            let { idPrefix: I } = (0, s.If)(),
                { isSelectable: S } = (0, c.v)(),
                { variant: L } = (0, d.e)(),
                { anyItemsWithActionBar: _, hasResizableActionsWithActionBar: P } = (0, o.Z)(),
                E = (0, n.useId)(),
                { isSelected: M, onSelect: B } = (0, w.r)(),
                { status: T } = (0, b.x)(),
                { title: R, titleAction: V, headingRef: k } = (0, C.J)(),
                { description: O } = (0, v.L)(),
                { hasNewActivity: z } = (0, N.I)(),
                W = (0, n.useRef)(null);
            (0, n.useEffect)(() => {
                W.current && t && document.activeElement?.tagName === "BODY" && W.current.focus()
            });
            let H = (0, n.useCallback)(e => {
                    ...
                    case "Enter":
                        if (V) {
                            let t = document.activeElement,
                                r = W.current === t,
                                i = k.current && (k.current === t || k.current.contains(t));
                            (r || i) && V(e)
                        }
                        break;
                    case " ":
                        if (!S || W?.current !== document.activeElement)
                            break;
                        e.preventDefault(),
                            B(!M);
                        break;
                ...
                $ = (0, n.useCallback)(() => {
                    let e = M ? "Selected" : "",
                        t = z ? "New activity" : "",
                        r = !!m,
                        i = Array.isArray(a) && a.length > 0 || a && !Array.isArray(a),
                        l = "";
                    ...
                    let s = [e, n, O, t, l].filter(e => e.trim()).join(". ");
                    return s.endsWith(".") ? s : `${s}.`
                }, [m, a, M, z, R, T, O]);
            return (0, i.jsxs)(g || "li", {
                ref: W,
                id: `${I}-list-view-node-${E}`,
                className: (0, l.$)(y.listItem, M && y.selected, "compact" === L && y.compact, _ && P && y.hasActionBar, f),
                tabIndex: -1,
                "aria-label": $(),
                style: h,
                onKeyDown: H,
                ...j,
                children: [r, e, Array.isArray(a) && a.length > 0 ? (0, i.jsx)(x, {
                    style: p,
                    className: A,
                    children: a.map((e, t) => (0, i.jsx)(n.Fragment, {
                        children: e
                    }, t))
                }) : !!(a && !Array.isArray(a)) && (0, i.jsx)(x, {
                    style: p,
                    className: A,
                    children: a
                }), m ?? (_ && (0, i.jsx)(u.L, {}))]
            ...
            g = ({ children: e, isSelected: t = !1, onSelect: r = a.l, ...l }) => {
    ...
    98391: (e, t, r) => {
        ...
        let s = () => {
            let e = (0, a.useContext)(l);
            if (!e)
                throw Error("useListItemNewActivity must be used with NewActivityProvider.");
            return e
        };
        try {
            ...
            c = ({ children: e, value: { isSelected: t, onSelect: r } }) => {
                let { title: l } = (0, s.J)(),
                    c = (0, n.useMemo)(() => ({
                        isSelected: t,
                        onSelect: e => {
                            (0, a.i)(e ? `Selected. ${l}.` : `Unselected. ${l}.`),
                                r(e)
                        }
                    }), [t, r, l]);
                return (0, i.jsx)(o.Provider, {
    ...
    84905: (e, t, r) => {
        ...
        function y(e, t) {
            ...
            for (; o instanceof HTMLElement && o.parentElement?.closest("[role=list] li[aria-expanded=false]");)
        ...
        function x(e, t) {
            let r = [...(0, h.K1)(document.documentElement, {
                strict: !0,
                onlyTabbable: !0
            })],
                i = r.indexOf(e);
        ...
        var N = r(29447),
            w = r(16946);
        let b = {
            ul: "ListView-module__ul--vMLEZ",
            container: "ListView-module__container--zF6wW"
        };
        var C = r(25654),
            A = r(89992),
            g = r(74304),
            j = r(78563);
        let I = ({ title: e, titleHeaderTag: t, children: r, totalCount: l, selectedCount: s = 0, variant: o = d.tp, singularUnits: u, pluralUnits: m, onVariantChange: h = a.l, isSelectable: v, hasDragHandle: y, ...f }) => {
            let [p, x] = (0, n.N)(o);
            (0, c.useEffect)(() => {
                h?.(p)
            }, [h, p]);
            let b = (0, c.useMemo)(() => c.Children.toArray(r).length, [r]);
            return (0, i.jsx)(N.JE, {
            ...
            S = ({ metadata: e, children: t, className: r, listRef: a, ariaLabelledBy: n, itemsListClassName: d, itemsListStyle: w, strictFocusZone: C, as: A, role: j, ...I }) => {
                let { idPrefix: S } = (0, N.If)(),
                    { title: L, titleHeaderTag: _ } = (0, g.t)(),
                    { containerRef: P } = function (e = !0) {
                        let t = void 0 === e || e,
                            r = m.z0.ArrowVertical | m.z0.HomeAndEnd | m.z0.PageUpDown | m.z0.Tab,
                            i = (0, u.zw)() ? r | m.z0.JK : r,
                            { containerRef: a } = (0, v.G)({
                                ...
                                focusableElementFilter: e => "list" !== e.getAttribute("role"),
                                    ...
                                    if (r instanceof HTMLElement) {
                                        if ("Tab" === i.key || "Tab" === i.code) {
                                            ...
                                            let a = [...(0, h.K1)(e, {
                                                ...
                                                l = a.findIndex(e => e.parentElement?.getAttribute("data-listview-component") === "trailing-badge"),
                                                n = a.findIndex(e => "selection-input" === e.getAttribute("data-listview-component"));
                                            l >= 0 && n >= 0 && (a.splice(l, 0, a[n]), a.splice(n + 1, 1));
                                            let s = a.indexOf(i.target);
                                            return s !== a.length - 1 || i.shiftKey ? s > 0 ? i.shiftKey ? a[s - 1] : a[s + 1] : void 0 : x(r, "next")
                                        }
                                        if ("previous" === e)
                                            return y(r, e) || f(r);
                                        if ("next" === e)
                ...
                let E = n ?? `${S}-list-view-container-title`;
                return (0, i.jsxs)("div", {
                    id: `${S}-list-view-container`,
                    className: (0, o.$)(b.container, r),
                    children: [!n && (0, i.jsx)(s.A, {
                        className: "sr-only",
                        as: _,
                        id: E,
        ...
        try {
            I.displayName || (I.displayName = "ListView")
        } catch { }
        try {
            S.displayName || (S.displayName = "ListViewContainer")
        } catch { }
    },
    25654: (e, t, r) => {
        r.d(t, {
    ...
    89992: (e, t, r) => {
        ...
        let s = "list item",
            ...
            d = ({ children: e, countOnPage: t = 0, singularUnits: r = s, pluralUnits: a = o, totalCount: d, selectedCount: u = 0, isSelectable: m = n.eX, hasDragHandle: h = n.os } = {
                singularUnits: s,
                pluralUnits: o,
                selectedCount: 0,
                countOnPage: 0,
