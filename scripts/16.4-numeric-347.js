        ...
        90254: function _(e, n, t) {
            ...
            function o(e, n, t, r, o) {
                ...
                for (var l = 0, a = u.length, s = 0, f = 0; l < a; l++) {
                    var c = u[l];
                    if (c.removed)
                        ((c.value = e.join(r.slice(f, f + c.count))),
                            (f += c.count));
                    else {
                        if (!c.added && o) {
            ...
            (t.d(n, {
                ...
                (r.prototype = {
                    diff: function diff(e, n) {
                        ...
                        var a = (n = this.removeEmpty(this.tokenize(n, r)))
                                .length,
                            s = e.length,
                            f = 1,
                            c = a + s;
                        null != r.maxEditLength &&
                            (c = Math.min(c, r.maxEditLength));
                    ...
                    addToPath: function addToPath(e, n, t, r, o) {
                    ...
                    extractCommon: function extractCommon(e, n, t, r, o) {
                        for (
                            var i = n.length,
                                u = t.length,
                                l = e.oldPos,
            ...
            ((v.equals = function (e, n, t) {
                ...
                (v.tokenize = function (e) {
                    ...
                    if (t.intlSegmenter) {
                        if (
                            "word" !=
                            t.intlSegmenter.resolvedOptions().granularity
                        )
                            throw Error(
                                'The segmenter passed must have a granularity of "word"'
                            );
                        n = Array.from(
                            t.intlSegmenter.segment(e),
                            function (e) {
                                return e.segment;
                            }
                        );
            ...
            function O(e, n) {
                ...
                (o.autoConvertLineEndings ||
                    null == o.autoConvertLineEndings) &&
                    (!e.includes("\r\n") ||
                    e.startsWith("\n") ||
                    e.match(/[^\r]\n/) ||
