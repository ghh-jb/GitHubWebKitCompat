...
performance.mark("js-parse-end:90501-525489325cac88dc.js");
("use strict");
        ...
        570170: function _(e, t, n) {
            ...
            function r(e) {
                ...
                var _ref2 =
                    ...
                    o = _ref2$once === void 0 ? !1 : _ref2$once;
                return i(e, t, {
                    start: n,
                    middle: a,
                    once: o,
        ...
        911117: function _(e, t, n) {
            ...
            function g(e) {
                if (
                    ...
                    var t = (1 === e.eventPhase ? a : r)[e.type];
                    if (t) {
                        ...
                        if (n.length) {
                            ...
                            for (
                                ...
                                c.set(e, g.node);
                                for (
                                    var b = 0, f = g.observers.length;
                                    b < f && !s.get(e);
                                    b++
                                )
                                    g.observers[b].data.call(g.node, e);
                            }
                            (c.delete(e), m(e));
                        }
                    }
            ...
            function b(e, t, n) {
                ...
                (l ||
                    ((l = new i.A()),
                    (c[e] = l),
                    document.addEventListener(e, g, s)),
                    l.add(t, n));
            }
            function f(e, t, n) {
        ...
        70837: function _(e, t, n) {
            function i() {
                ...
                for (
                    ...
                    var _i3 = _Array$from[_i2];
                    var r = _i3.name,
                        a = _i3.content,
                        o = r.replace("".concat(e, "-"), "").replace(/-/g, "_");
                    "url" === o ? (t = a) : (n[o] = a);
                }
                if (!t)
                    throw Error(
